...
#+BEGIN_SRC emacs-lisp
(setq auth-sources
      (list (concat-path user-emacs-directory "authinfo.gpg")))
#+END_SRC
...
Set the default column view for all files.
...
(setq org-tag-alist
      '((:startgrouptag)
        ("generic")
        (:grouptags)
        ("idea" . ?i) ("call" . ?c) ("errand" . ?e) ("pay" . ?p) ("remind" . ?r)
        (:endgrouptag)
        ...
        ("hobbies")
        (:grouptags)
        ("diving" . ?d) ("hacking" . ?h) ("music" . ?m) ("synth" . ?s) ("blogging" . ?b)
        (:endgrouptag)
        
        (:startgrouptag)
        ("travel")
        (:grouptags)
        ("flight" . ?F) ("car" . ?C) ("train" . ?t) ("hotel" . ?s) ("event" . ?v)
        ("outb" . ?>) ("inb" . ?<)
        (:endgrouptag)
...
Useful extras. Specifically the property package can be customized with
~org-agenda-property-list~ and ~org-agenda-property-position~.
...
(setq org-agenda-custom-commands
      '(("c" "TODO closed last week"
         tags "TODO=\"DONE\"&CLOSED>=\"<-1w>\""
         ((org-agenda-overriding-header "TODO Closed last week:")
          (org-agenda-sorting-strategy '(priority-down effort-down))
          (org-agenda-overriding-columns-format "%45ITEM(Task) %1PRIORITY(!) %23SCHEDULED(Scheduled to Start) %22DEADLINE(Deadline) %22CLOSED(Closed on) %30ALLTAGS(All Tags)")

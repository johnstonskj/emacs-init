...
(when (skj/current-feature-required-p)
  ...
  (use-package zotero
    ...
    :custom
    (zotero-auth-token
     (zotero-auth-token-create :token (auth-source-pass-get 'secret "Zoteron/api-key")
                               :token-secret (auth-source-pass-get 'secret "Zoteron/api-key")
                               :userid (auth-source-pass-get 'secret "Zoteron/userid")
